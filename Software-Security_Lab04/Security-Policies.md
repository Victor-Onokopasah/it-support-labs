...
- **Software Request Process:** All software must be requested through the IT Service Management portal.
...
- **Access Reviews:** User access rights will be reviewed quarterly.
